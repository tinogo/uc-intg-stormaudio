...
class SimpleCommands(StrEnum):
    ...
    DOLBY_CENTER_SPREAD_ON = "DOLBY_CENTER_SPREAD_ON"
    DOLBY_CENTER_SPREAD_OFF = "DOLBY_CENTER_SPREAD_OFF"
    DOLBY_CENTER_SPREAD_TOGGLE = "DOLBY_CENTER_SPREAD_TOGGLE"
...
class StormAudioCommands(StrEnum):
    ...
    SURROUND_MODE_X_FORMAT = "ssp.surroundmode.[{}]"
    PRESET_NEXT = "ssp.preset.next"
    PRESET_PREV = "ssp.preset.prev"
    PRESET_X_FORMAT = "ssp.preset.[{}]"
    ...
    DOLBY_CENTER_SPREAD_ON = "ssp.cspread.on"
    DOLBY_CENTER_SPREAD_OFF = "ssp.cspread.off"
    DOLBY_CENTER_SPREAD_TOGGLE = "ssp.cspread.toggle"
...
class StormAudioResponses(StrEnum):
    ...
    BASS_X = "ssp.bass."
    TREBLE_X = "ssp.treble."
    BRIGHTNESS_X = "ssp.brightness."
    CENTER_ENHANCE_X = "ssp.c_en."
    SURROUND_ENHANCE_X = "ssp.s_en."
    LFE_ENHANCE_X = "ssp.lfe_en."
    ...
    VIDEO_HDMI_1_COPY_PROTECTION_X = "ssp.hdmi1.cp."
    ...
    VIDEO_HDMI_2_COPY_PROTECTION_X = "ssp.hdmi2.cp."
